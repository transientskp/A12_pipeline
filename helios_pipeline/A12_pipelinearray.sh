...
singularity exec -B /hddstore/mkuiack1/:/opt/Data/,/zfs/helios/filer1/mkuiack1/:/opt/Archive/,/hddstore/idayan/:/opt/Data/  \
        $HOME/lofar-pipeline.simg  $HOME/A12_pipeline/helios_pipeline/run_trim_a2m.sh \
        $SB $START $END $INPUT

mkdir "/zfs/helios/filer1/idayan/"$OBS"/"$SLICE"_all/"
